...
function Review() {
  ...
  const starHandler = (e) => {
    ...
    [...e.target.parentNode.children].forEach((star, index) => {
      if (star.classList.contains("fa-solid")) {
        [...e.target.parentNode.children].forEach((ele, ind) => {
          if (ind <= index) {
      ...
      <div className="review">
        <div className="reviewTitles">
          <NavLink
            to="/"
            className="reviews1"
            style={{ borderBottom: "2px solid #00000045" }}
          >
            تقييمات المنتج{" "}
          </NavLink>
          <NavLink to="/" className="reviews2">
            معلومات اضافية{" "}
          </NavLink>
          <NavLink to="/" className="reviews3">
            الوصف{" "}
          </NavLink>
        </div>
        {/* addReview */}
        <div className="addReview">
          ...
          />
          <div
            className="addRev buyNow proName"
            data-name="addRev"
            onClick={addRevHandeler}
            style={{
              position: "relative",
              top: "3%",
              width: "27%",
